...
case "${1:-}" in
    ...
    fuentes)   conjunto="tests/test_fuentes_ext.py tests/test_fuentes_bordes.py tests/test_fuentes_config.py tests/test_fuentes_notif.py tests/test_fuentes_prompt.py tests/test_dashboard_clima.py" ;;
    gtk)       conjunto="tests/test_gtk_clima.py" ;;
    "")        conjunto="tests/test_protocolo.py tests/test_simulador.py tests/test_temas.py tests/test_video.py tests/test_regresiones.py tests/test_rendimiento.py tests/test_ejemplos.py tests/test_fuentes_ext.py tests/test_fuentes_bordes.py tests/test_fuentes_config.py tests/test_fuentes_notif.py tests/test_fuentes_prompt.py tests/test_dashboard_clima.py tests/test_gtk_clima.py" ;;
