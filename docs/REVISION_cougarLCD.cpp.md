...
> **Que aporta este documento.** Revision de `cougarLCD.cpp`, una implementacion
> independiente del mismo protocolo: que coincide, que no, y que se aprendio de ella
> (por ejemplo que espera el acuse de los bloques).
